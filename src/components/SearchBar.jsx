...
const Search = () => {
    ...
    return (
      <div className="form-control flex flex-row gap-2 w-full md:w-auto justify-center">
          <input 
            type="text" 
            value={text} 
            ...
            placeholder="Search Skills/Developers" 
            className="input input-bordered w-full md:w-64 lg:w-80"
          />
          <button className="bg-white opacity-80 rounded-lg px-4" onClick={handleSearch}>🔍</button>
      </div>
    );
};
